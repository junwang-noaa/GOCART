...
!   Carbonaceous aerosols
    do n = 1, size(self%CA%instances)
       if ((self%CA%instances(n)%is_active) .and. (index(self%CA%instances(n)%name, 'data') == 0 ) &
          ...
          call MAPL_GetPointer (gex(self%CA%instances(n)%id), bcextcoef, 'CAEXTCOEFCA.bc', __RC__)
          ...
          call MAPL_GetPointer (gex(self%CA%instances(n)%id), ocextcoef, 'CAEXTCOEFCA.oc', __RC__)
          ...
          call MAPL_GetPointer (gex(self%CA%instances(n)%id), brextcoef, 'CAEXTCOEFCA.br', __RC__)
